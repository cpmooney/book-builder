...
import { getBookTOC, updateBook } from '@/features/books/data';
import type { Book } from '@/types/book-builder';
      ...
      <div className="max-w-4xl mx-auto p-4 lg:p-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Update the title and summary for this book
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Enter a brief summary of this book"
            />
            <p className="mt-2 text-sm text-gray-500">
              A concise overview that describes what this book covers
            </p>
          </div>
